...
const PortfolioHome: React.FunctionComponent<IPortfolioHomeProps> = ({portfolios, investor, handleAddMoneySubmit, stockRatings,
    ...
    return (
        <div className="container">
            ...
            <div className="row mb-5"><Salutation investor={investor}/></div>
            ...
            <div className="container  mb-5">
                <div className="row text-center mb-5"><h2>ESG Ratings Goals and Current Portfolio ESG Ratings</h2></div>
